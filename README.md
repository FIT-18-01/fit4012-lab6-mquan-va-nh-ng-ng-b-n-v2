...
- **Thành viên 1**: Trương Triệu Việt Hoàng - MSSV: 1871020252 
- **Thành viên 2**: Trần Minh Quân - MSSV: 1871020469 

## Task division

- **Thành viên 1 phụ trách chính**: aes_socket_utils.py, sender.py, test padding, test key channel
- **Thành viên 2 phụ trách chính**: receiver.py, test data channel, test wrong key, test tamper, test integration 
- **Phần làm chung**: threat model, report, peer review response, log minh chứng
